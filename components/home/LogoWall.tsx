  ...
  return (
    <section className="bg-primary border-y border-white/5 py-10 lg:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <p className="text-center text-[10px] sm:text-xs font-bold tracking-[0.3em] uppercase text-white/65 mb-7 lg:mb-8">
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 lg:gap-16 items-center">
            {oems.map((oem) => (
              ...
              >
                ...
                <p className="mt-2 text-[9px] sm:text-[10px] font-semibold tracking-widest uppercase text-white/55">
                  {oem.subtitle}
                </p>
              </div>
            ))}
